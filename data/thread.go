...
func (thread *Post) CreatedAtDate() string {
	return thread.CreatedAt.Format("Jan 2, 2006 at 3:04pm")
}
...
func (user *User) CreatePost(conv Thread, body string) (post Post, err error) {
	...
	defer stmt.Close()
	// Use QueryRow to reurn a row and scan the returned id into the Session struct
...
// Gets all threads in the database and returns it
